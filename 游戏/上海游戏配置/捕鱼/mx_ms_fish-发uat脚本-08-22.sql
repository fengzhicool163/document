...
Source Server         : dev-09
Source Server Version : 50725
Source Host           : service.80021.xyz:36360
Source Database       : mx_ms_fish

Target Server Type    : MYSQL
Target Server Version : 50725
File Encoding         : 65001

Date: 2019-08-22 11:12:25
*/
...
CREATE TABLE `fish_battery` (
  `battery_id` bigint(13) NOT NULL AUTO_INCREMENT COMMENT '炮台id',
  ...
  `send_interval` bigint(13) DEFAULT NULL COMMENT '发射间隔',
  `rebound_nums` int(4) DEFAULT NULL COMMENT '反弹次数 ',
  `consu_gold` bigint(13) DEFAULT NULL COMMENT '消耗金币',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='炮台属性表';
...
CREATE TABLE `fish_boss` (
  `boss_id` bigint(13) NOT NULL AUTO_INCREMENT COMMENT 'boss鱼机制id ',
  `boss_name` varchar(20) DEFAULT NULL COMMENT 'boss鱼机制名称',
  `consume_coins` bigint(13) DEFAULT NULL COMMENT '累计消耗鱼币 ',
  `damp_nums` int(11) DEFAULT NULL COMMENT '鱼潮次数 ',
  `refr_interval_time` bigint(13) DEFAULT NULL COMMENT '刷新间隔(秒) ',
  `kill_coin_award` bigint(13) DEFAULT NULL COMMENT '完美击杀鱼币奖励 ',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`boss_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='BOSS鱼机制表';
...
CREATE TABLE `fish_damp` (
  ...
  `consu_fish_coins` bigint(13) DEFAULT NULL COMMENT '累计消耗鱼币',
  `refr_interval_time` bigint(13) DEFAULT NULL COMMENT '刷新间隔',
  `track_list` text COMMENT '鱼潮轨迹集合 例：[{"lineId":1,"fishIds":"23,456,466"}]',
  `suffer_award` bigint(13) DEFAULT NULL COMMENT '完美击杀经验奖励',
  `fish_coin_award` bigint(13) DEFAULT NULL COMMENT '完美击杀鱼币奖励',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`damp_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1002 DEFAULT CHARSET=utf8 COMMENT='鱼潮机制表';
...
CREATE TABLE `fish_damp_track` (
  `track_id` bigint(13) NOT NULL AUTO_INCREMENT COMMENT '轨迹id',
...
CREATE TABLE `fish_drop` (
  `drop_id` bigint(13) NOT NULL AUTO_INCREMENT COMMENT '掉落机制id',
...
CREATE TABLE `fish_drop_group` (
  `group_id` bigint(13) NOT NULL AUTO_INCREMENT COMMENT '组id',
  `group_name` varchar(20) DEFAULT NULL COMMENT '掉落组名称',
  `prop_id` bigint(13) DEFAULT NULL COMMENT '道具id',
...
CREATE TABLE `fish_info` (
  ...
  `vals` bigint(13) DEFAULT NULL COMMENT '鱼的价值',
  ...
  `refresh_gap` bigint(13) DEFAULT NULL COMMENT '刷新间隔',
  `survive_time` bigint(13) DEFAULT NULL COMMENT '鱼的存活时间（秒）',
...
INSERT INTO `fish_info` VALUES ('Fish025', '鱼王', '20', '30', '22', '99', '15', '1', '60', '200', '3', '3', '', null, 'Traj006', 'skill006', '2019-07-04 14:39:48', '2019-07-17 13:58:09');
...
CREATE TABLE `fish_pool` (
  ...
  `draw_rate` bigint(13) DEFAULT NULL COMMENT '抽水比例',
...
-- ----------------------------
INSERT INTO `fish_pool` VALUES ('1', '新手房', '10', '-99999999999-100', '101-35000', '35001-50000', '50001-70000', '70001-90000', '90001-150000', '150001-9999999999', '2019-08-20 17:37:11', '2019-08-20 17:37:11');
INSERT INTO `fish_pool` VALUES ('2', '进阶房', '10', '-99999999999-5000', '5001-200000', '200001-350000', '350001-500000', '500001-600000', '600001-1000000', '1000001-9999999999', '2019-08-20 17:37:00', '2019-08-20 17:37:00');
INSERT INTO `fish_pool` VALUES ('3', '高手房', '10', '-99999999999-20000', '20001-900000', '900001-1100000', '1100001-1500000', '1500001-3000000', '3000001-5000000', '5000001-9999999999', '2019-08-20 17:37:23', '2019-08-20 17:37:23');
INSERT INTO `fish_pool` VALUES ('4', '土豪房', '10', '-99999999999-50000', '50001-3300000', '3300001-5000000', '5000001-7000000', '7000001-9000000', '9000001-15000000', '15000001-9999999999', '2019-08-20 17:37:34', '2019-08-20 17:37:34');
...
CREATE TABLE `fish_pool_reward` (
  `reward_id` bigint(13) NOT NULL AUTO_INCREMENT COMMENT '返奖率配置ID',
  `reward_level` int(4) DEFAULT NULL COMMENT '档位（数字表示）',
  `reward_rate` bigint(13) DEFAULT NULL COMMENT '返奖率',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
...
CREATE TABLE `fish_prop` (
  `prop_id` bigint(13) NOT NULL AUTO_INCREMENT COMMENT '道具ID',
  ...
  `gold_value` bigint(13) DEFAULT NULL COMMENT '金币价值',
  `conver_value` bigint(13) DEFAULT NULL COMMENT '兑换价格（奖牌）',
...
CREATE TABLE `fish_site` (
  ...
  `gold_consume` bigint(13) DEFAULT NULL COMMENT '金币消耗 ',
  `gold_down` bigint(13) DEFAULT NULL COMMENT '金币下限 ',
  `gold_up` bigint(13) DEFAULT NULL COMMENT '金币上限',
  ...
  `pause_time` bigint(13) DEFAULT NULL COMMENT '静默时间（秒) ',
  `toin_interval_time` bigint(13) DEFAULT NULL COMMENT '互动间隔（秒） ',
  `cowry_interval_time` bigint(13) DEFAULT NULL COMMENT '宝箱投放间隔（秒） ',
  `open_time` bigint(13) DEFAULT NULL COMMENT '开启时间',
  `open_conti_time` bigint(13) DEFAULT NULL COMMENT '开启持续时间（秒） ',
  `single_conti_time` bigint(13) DEFAULT NULL COMMENT '单次持续时间（秒） ',
...
-- ----------------------------
INSERT INTO `fish_site` VALUES ('1', '1', '新手房', '0', '-1', '10', '100000', '1', '50', '1', '60', '10', '180', '-1', '-1', '-1', '1', '2', '-1', 'Fish001,Fish004,Fish006,Fish009,Fish010,Fish014,Fish019,Fish020,Fish023,Fish024,Fish025,Fish114,Fish117,Fish119,Boss001,Boss005', '1', '2019-07-02 17:03:01', '2019-08-20 17:37:11');
INSERT INTO `fish_site` VALUES ('2', '1', '进阶房', '0', '-1', '50000', '500000', '50', '200', '50', '60', '10', '180', '-1', '-1', '-1', '2', '3', '-1', 'Fish001,Fish004,Fish006,Fish009,Fish010,Fish014,Fish019,Fish020,Fish023,Fish024,Fish025,Fish114,Fish117,Fish119,Boss002,Boss006', '1', '2019-07-02 17:06:09', '2019-08-20 17:37:00');
INSERT INTO `fish_site` VALUES ('3', '1', '高手房', '0', '-1', '250000', '2500000', '200', '500', '200', '60', '10', '180', '-1', '-1', '-1', '3', '4', '-1', 'Fish001,Boss003,Boss007,Fish004,Fish006,Fish009,Fish010,Fish014,Fish019,Fish020,Fish023,Fish024,Fish025,Fish114,Fish117,Fish119', '1', '2019-07-02 17:10:43', '2019-08-20 17:37:23');
INSERT INTO `fish_site` VALUES ('4', '1', '土豪房', '0', '-1', '1000000', '-1', '500', '1000', '500', '60', '10', '180', '-1', '-1', '-1', '4', '5', '-1', 'Fish001,Boss004,Boss008,Fish004,Fish006,Fish009,Fish010,Fish014,Fish019,Fish020,Fish023,Fish024,Fish025,Fish114,Fish117,Fish119', '1', '2019-07-02 17:15:27', '2019-08-20 17:37:34');
...
-- ----------------------------
INSERT INTO `fish_site_refr` VALUES ('1', '15', '1:70,2:0,3:30', '7', '100', '2019-07-02 17:03:01', '2019-08-20 17:37:11');
INSERT INTO `fish_site_refr` VALUES ('2', '15', '1:70,2:0,3:30', '7', '100', '2019-07-02 17:06:09', '2019-08-20 17:37:00');
INSERT INTO `fish_site_refr` VALUES ('3', '15', '1:70,2:0,3:30', '7', '100', '2019-07-02 17:10:43', '2019-08-20 17:37:23');
INSERT INTO `fish_site_refr` VALUES ('4', '15', '1:70,2:0,3:30', '7', '100', '2019-07-02 17:15:27', '2019-08-20 17:37:34');
...
CREATE TABLE `fish_skill` (
  ...
  `consu_energy` bigint(13) DEFAULT NULL COMMENT '能量消耗',
  `prop_id` bigint(13) DEFAULT NULL COMMENT '道具id ',
  `prop_consu` bigint(13) DEFAULT NULL COMMENT '道具消耗',
  `consu_gold` bigint(13) DEFAULT NULL COMMENT '金币消耗 ',
  ...
  `free_time` bigint(13) DEFAULT NULL COMMENT '释放时间 ',
  `conti_time` bigint(13) DEFAULT NULL COMMENT '持续时间（秒) ',
  `cd_time` bigint(13) DEFAULT NULL COMMENT '冷却时间（秒） ',
  `cd_force` bigint(13) DEFAULT NULL COMMENT '全场强制冷却（秒） ',
  `bullet_up` bigint(13) DEFAULT NULL COMMENT '炮台子弹加成（秒）',
  `down_attack_time` bigint(13) DEFAULT NULL COMMENT '降低炮台攻击间隔（毫秒）',
  `slow_down_time` bigint(13) DEFAULT NULL COMMENT '持续减速时间（毫秒）',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
...
CREATE TABLE `fish_user_grade` (
  ...
  `grade_award` bigint(13) DEFAULT NULL COMMENT '成就点奖励',
  `gold_award` bigint(13) DEFAULT NULL COMMENT '金币奖励',
...
CREATE TABLE `fish_user_level` (
  ...
  `requir_suffer` bigint(13) DEFAULT NULL COMMENT '所需升级经验',
  `up_suffer_award` bigint(13) DEFAULT NULL COMMENT '升级金币奖励',
  `battery_multiple` int(11) DEFAULT NULL COMMENT '炮台倍数',
  `battery_id` bigint(13) DEFAULT NULL COMMENT '体验炮id',
  `touch_time` bigint(13) DEFAULT NULL COMMENT '体验时长',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`user_id`)
...
CREATE TABLE `fish_vip_user` (
  ...
  `recharge_amt` bigint(13) DEFAULT NULL COMMENT '充值金额',
  `battery_id` bigint(13) DEFAULT NULL COMMENT '炮台id',
  `suffer_up` bigint(13) DEFAULT NULL COMMENT '经验加成',
  `prop_up` bigint(13) DEFAULT NULL COMMENT '道具掉路加成',
